<template>
    <div class="w-full px-4 max-w-[1000px] mx-auto">
                ...
                <picnic-b-rule>
                    ...
                    <template #content>
                        ...
                        <ul class="list-disc mb-6">
                            ...
                            <li>因他組斷線導致落敗的組別，需於當局比賽結束時，於<picnic-b-mark>聯繫主辦／問答諮詢</picnic-b-mark>出示任天堂app截圖證明（截圖需包含時間與八位玩家id）</li>
                            <li>地圖全隨機，不 BAN 圖。</li>
        ...
        <div class="w-full grid grid-cols-1 lg:grid-cols-2 grid-flow-row md:flex-row flex-wrap items-stretch gap-4 md:px-0">
